# taken from https://github.com/yilundu/irem_code_release/blob/master/graph_dataset.py
...
class Identity(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        R = np.random.uniform(-1, 1, (rank, rank)) #low, high, size
        R_corrupt = R
        ...
        # n = rank
        # print("x shape is ",node_features.shape," and is ", node_features) # is [n,1]
        ...
        # print("y is shape ",edge_features_label.shape," and is ",edge_features_label) # [n^2,1]
        # print("edge index is ", edge_index.shape) # 2, n^2
        # print("edge feature context is", edge_features_context.shape) # same as edge_features_label are !!!!!continuous features!!!!!
        # sys.exit()
